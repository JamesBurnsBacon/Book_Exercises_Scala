...
parent      =  extends CommandLineParser.FromString[LocalDate] {
  def fromString(s: String) =
    LocalDate = Try(LocalDate.parse(s)) mat _root_.scala.Predef.???
} # -1,
parent span = <3362..3494>,
child       = def fromString(s: String) =
  LocalDate = Try(LocalDate.parse(s)) mat _root_.scala.Predef.??? # -1,
child span  = [3415..3419..3495]
