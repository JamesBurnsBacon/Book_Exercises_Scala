...
parent      =  extends CommandLineParser.FromString[LocalDate] {
  def fromString(s: String) = _root_.scala.Predef.???
} # -1,
parent span = <3401..3714>,
child       = def fromString(s: String) = _root_.scala.Predef.??? # -1,
child span  = [3454..3458..3721]
...
object DaysBetweenDates {
    ...
    def run(date1:String, date2:String): Unit =
        Try
            ...
            val daysBetween = jave.time.temporal.ChronoUnit.DAYS.between(firstDate, secondDate).abs
