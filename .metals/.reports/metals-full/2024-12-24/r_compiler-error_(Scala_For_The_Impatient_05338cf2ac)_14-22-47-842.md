...
parent      =  extends CommandLineParser.FromString[LocalDate] {
  def fromString(s: String) =
    LocalDate = Try(LocalDate.parse(s)) ma _root_.scala.Predef.???
} # -1,
parent span = <3715..3852>,
child       = def fromString(s: String) =
  LocalDate = Try(LocalDate.parse(s)) ma _root_.scala.Predef.??? # -1,
child span  = [3771..3775..3856]
